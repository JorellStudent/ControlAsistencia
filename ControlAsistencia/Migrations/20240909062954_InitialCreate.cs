        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Asistencias_Usuarios_UsuarioIdUsuario",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Auditorias_Usuarios_UsuarioIdUsuario",
                        column: x => x.UsuarioIdUsuario,
                        principalTable: "Usuarios",
                        principalColumn: "IdUsuario",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Credencial", x => x.IdCredencial);
                    table.ForeignKey(
                        name: "FK_Credencial_Roles_RolIdRol",
                        column: x => x.RolIdRol,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HorariosTrabajo", x => x.IdHorario);
                    table.ForeignKey(
                        name: "FK_HorariosTrabajo_Usuarios_UsuarioIdUsuario",
                        column: x => x.UsuarioIdUsuario,
                        principalTable: "Usuarios",
                        principalColumn: "IdUsuario",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdNotificacion = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    IdUsuario = table.Column<int>(type: "int", nullable: false),
                    TipoNotificacion = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Permisos_Usuarios_UsuarioIdUsuario",
                        column: x => x.UsuarioIdUsuario,
                        principalTable: "Usuarios",
                        principalColumn: "IdUsuario",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Asistencias_UsuarioIdUsuario",
                table: "Asistencias",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Auditorias_UsuarioIdUsuario",
                table: "Auditorias",
                column: "UsuarioIdUsuario");

            migrationBuilder.CreateIndex(
                name: "IX_Credencial_RolIdRol",
                table: "Credencial",
                column: "RolIdRol");

            migrationBuilder.CreateIndex(
                name: "IX_Credencial_UsuarioIdUsuario",
                table: "Credencial",
                column: "UsuarioIdUsuario");

            migrationBuilder.CreateIndex(
                name: "IX_HorariosTrabajo_UsuarioIdUsuario",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permisos_UsuarioIdUsuario",
                table: "Permisos",
                column: "UsuarioIdUsuario");
        }
